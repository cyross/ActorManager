...
import type { ActorSpec, ActorDetail, EditActorInfo, ActorColorInfo, ActorTextAttr } from "../types/actor";
...
export const useActorStore = defineStore('actor', () =>{
  ...
  const applyEditFromDetail = () => {
    ...
    setupColor(
      edit.value.JimakuAttr.TextColor,
      detail.value.Body.JimakuTextColor
    );
    setupColor(
      edit.value.JimakuAttr.OutlineColor,
      detail.value.Body.JimakuOutlineColor
    );
    edit.value.JimakuAttr.OutlineWidth =
      detail.value.Body.JimakuOutlineWidth;
    setupColor(
      edit.value.ActorNameAttr.TextColor,
      detail.value.Body.ActorTextColor
    );
    setupColor(
      edit.value.ActorNameAttr.OutlineColor,
      detail.value.Body.ActorOutlineColor
    );
    edit.value.ActorNameAttr.OutlineWidth =
      detail.value.Body.ActorOutlineWidth;
